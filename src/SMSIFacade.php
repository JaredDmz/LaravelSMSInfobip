          ...
          $password = env(SMS_PASSWORD,false);
	        if($username != false && $password != false) {
                ...
                curl_setopt_array($curl, array(
                  ...
                  CURLOPT_POSTFIELDS => '{"from":"ALIVIANATE","to":"52'.$telefono.'","text":"'.$mensaje.'"}',
	    	...
	    	return ['estatus'=>'no','mensaje'=>'El teléfono debe estar a 10 dígitos y el mensaje con algo escrito.'];
	    }
    }
}
